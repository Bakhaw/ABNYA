    ...
    return (
        <div className="courseContainer">
          <div className="col-md-10">
            <div>
              <p onClick={this.displaySousTitre} className="displaySubtitleButton">{chapitre4.nom}</p>
              {this.state.soustitre &&
                <p onClick={this.displayCours} className="displayCourseButton">{chapitre4.soustitre.nom}</p>
              }
              {this.state.cours &&
            ...
            {chapitre4.soustitre_2 &&
              <div>
                {this.state.soustitre &&
                  <p onClick={this.displayCours2} className="displayCourseButton">{chapitre4.soustitre_2.nom}</p>
                }
                {this.state.cours2 &&
            ...
            {chapitre4.soustitre_3 &&
              <div>
                {this.state.soustitre &&
                  <p onClick={this.displayCours3} className="displayCourseButton">{chapitre4.soustitre_3.nom}</p>
                }
                {this.state.cours3 &&
            ...
            {chapitre4.soustitre_4 &&
              <div>
                {this.state.soustitre &&
                  <p onClick={this.displayCours4} className="displayCourseButton">{chapitre4.soustitre_4.nom}</p>
                }
                {this.state.cours4 &&
            ...
            {chapitre4.soustitre_5 &&
              <div>
                {this.state.soustitre &&
                  <p onClick={this.displayCours5} className="displayCourseButton">{chapitre4.soustitre_5.nom}</p>
                }
                {this.state.cours5 &&
