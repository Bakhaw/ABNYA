  ...
  render() {
    ...
    return <div>
        ...
        <Dialog title="Modifier" modal={true} contentStyle={customContentStyle}
          ...
          <EditForm url={this.props.url} id={this.props.infos._id}
                    date={this.props.infos.date} titre={this.props.infos.titre}
                    soustitre={this.props.infos.soustitre} article={this.props.infos.article}
