  ...
  render() {
    ...
    return <div>
        ...
        <Dialog title="Modifier" modal={true} contentStyle={customContentStyle}
          ...
          <EditForm url={this.props.url} id={this.props.infos._id} date={this.props.infos.date} titre={this.props.infos.titre} article={this.props.infos.article} liens={this.props.infos.liens} />
